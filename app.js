...
const paragrapWithQuote = document.querySelector("p");
const makeQuote = (arr) => {
...
const showQuote = () =>{
   paragrapWithQuote.textContent = makeQuote(arr);
    paragrapWithQuote.style.color= colorArr[Math.round(Math.random()*(arr.length-1))];
}
